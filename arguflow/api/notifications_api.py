...
class NotificationsApi:
    ...
    def get_notifications(
        self,
        page: Annotated[StrictInt, Field(description="Page number of notifications to get")],
        ...
        :param page: Page number of notifications to get (required)
        :type page: int
    ...
    def get_notifications_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NotificationReturn]:
        """get_notifications
    ...
    def _get_notifications_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/notifications/{page}',
    ...
    def _mark_all_notifications_as_read_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/notifications_readall',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def mark_notification_as_read(
        self,
        notification_id: Annotated[NotificationId, Field(description="JSON request payload with id of notification to mark read")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param notification_id: JSON request payload with id of notification to mark read (required)
        :type notification_id: NotificationId
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
