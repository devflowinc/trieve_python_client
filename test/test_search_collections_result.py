...
class TestSearchCollectionsResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SearchCollectionsResult:
        """Test SearchCollectionsResult
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchCollectionsResult`
        """
        model = SearchCollectionsResult()
        if include_optional:
    ...
    def testSearchCollectionsResult(self):
        """Test SearchCollectionsResult"""
