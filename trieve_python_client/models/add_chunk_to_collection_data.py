...
class AddChunkToCollectionData(BaseModel):
    """
    AddChunkToCollectionData
    """ # noqa: E501
    chunk_id: StrictStr = Field(description="Id of the chunk to make a member of the collection. Think of this as \"bookmark\"ing a chunk.")
