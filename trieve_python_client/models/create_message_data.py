...
class CreateMessageData(BaseModel):
    ...
    CreateMessageData
    """ # noqa: E501
    model: Optional[StrictStr] = Field(default=None, description="The model to use for the assistant's messages. This can be any model from the model list. If no model is provided, the gryphe/mythomax-l2-13b will be used.")
    ...
    __properties: ClassVar[List[str]] = ["model", "new_message_content", "topic_id"]
