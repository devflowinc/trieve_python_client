...
class UpdateChunkData(BaseModel):
    ...
    chunk_uuid: StrictStr = Field(description="Id of the chunk you want to update.")
    ...
    tracking_id: Optional[StrictStr] = Field(default=None, description="Tracking_id is a string which can be used to identify a chunk. This is useful for when you are coordinating with an external system and want to use the tracking_id to identify the chunk. If no tracking_id is provided, the existing tracking_id will be used.")
    ...
    __properties: ClassVar[List[str]] = ["chunk_html", "chunk_uuid", "link", "metadata", "time_stamp", "tracking_id", "weight"]
