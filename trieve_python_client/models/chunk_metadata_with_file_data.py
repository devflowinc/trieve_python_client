...
class ChunkMetadataWithFileData(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["author", "chunk_html", "content", "created_at", "file_id", "file_name", "id", "link", "metadata", "qdrant_point_id", "tag_set", "time_stamp", "tracking_id", "updated_at", "weight"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "author": UserDTO.from_dict(obj["author"]) if obj.get("author") is not None else None,
